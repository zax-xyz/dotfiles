...
export PATH="/usr/lib/ccache/bin/:$PATH:$GOPATH/bin:$HOME/.local/bin:$HOME/.local/share/bin:$HOME/.local/share/gem/ruby/3.0.0/bin/:$HOME/.cargo/bin:/opt/homebrew/opt/rustup/bin"
